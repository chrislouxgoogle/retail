- dashboard: supply_chain_pulse_poctemplate
  title: Supply Chain Pulse PoC-Template
  layout: newspaper
  ...
  - title: 'C-301: Total Consumption (Global- All Markets)'
    ...
    width: 22
    height: 7
  - name: <i class="fa fa-rss-square fa" aria-hidden="true">Supply Chain Pulse</i>
    type: text
    title_text: <i class="fa fa-rss-square fa" aria-hidden="true">Supply Chain Pulse</i>
